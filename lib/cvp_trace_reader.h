...
struct CVPTraceReader
{
  ...
  db_t *populateNewInstr()
  {
     ...
     inst->is_alu = mInstr.mType == InstClass::aluInstClass;
     inst->is_cond_b = mInstr.mType == InstClass::condBranchInstClass;
     inst->is_uncond_d_b = mInstr.mType == InstClass::uncondDirectBranchInstClass;
     inst->is_uncond_i_b = mInstr.mType == InstClass::uncondIndirectBranchInstClass;
     inst->is_fp_inst = mInstr.mType == InstClass::fpInstClass;
     inst->is_slow_alu = mInstr.mType == InstClass::slowAluInstClass;
     inst->is_undef = mInstr.mType == InstClass::undefInstClass;
